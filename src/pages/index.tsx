...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`event and festival manager`}</title>

        <meta
          name="description"
          content="Welcome to Event and Festival Manager - Your comprehensive solution for seamless event and festival management. From user-friendly interfaces, task assignments, to rental product catalogs, we've got your event planning needs covered!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1511578314322-379afb476865?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxldmVudCUyMG1hbmFnZW1lbnR8ZW58MHx8fHwxNjkzNzcwMTIyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@chuttersnap?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`CHUTTERSNAP`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`event and festival manager`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Event and Festival Manager - Your comprehensive solution for seamless event and festival management. From user-friendly interfaces, task assignments, to rental product catalogs, we've got your event planning needs covered!`}
            </Text>
            <Box
